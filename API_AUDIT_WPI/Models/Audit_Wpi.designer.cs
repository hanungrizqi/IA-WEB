...
namespace API_AUDIT_WPI.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DB_CPMD_WPI_KPT")]
	public partial class Audit_WpiDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteTBL_R_TENTANG_IA_WEB(TBL_R_TENTANG_IA_WEB instance);
		...
		public Audit_WpiDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["DB_CPMD_WPI_KPTConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public Audit_WpiDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Audit_WpiDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Audit_WpiDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Audit_WpiDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnAksesChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Link_Menu", DbType="NVarChar(150)")]
